        ...
        <div className="mb-7 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm font-medium text-slate-500">
              Revisa el RUT y aprueba el sello de empresa verificada.
            </p>
          </div>
        ...
        <div className="space-y-4">
          {requests.length ? (
                ...
                <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                  <div className="min-w-0">
                    ...
                    {item.businessDescription ? (
                      <p className="mt-3 max-w-[700px] text-sm font-medium leading-relaxed text-slate-600">
                        {item.businessDescription}
                      </p>
                    ) : null}
                  </div>
                  ...
                  <div className="flex flex-col gap-3 sm:flex-row lg:items-center">
                    <a
                      href={`/api/admin/verification-document?type=business&requestId=${item.id}`}
                      target="_blank"
                      rel="noreferrer"
                    ...
                    <AdminBusinessVerificationActions
                      requestId={item.id}
                      status={item.status}
                    />
                  </div>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-8 text-center">
              ...
              <p className="mt-2 text-sm font-medium text-slate-500">
                Cuando una empresa envie el RUT aparecera aqui.
              </p>
            </div>
          )}
        </div>

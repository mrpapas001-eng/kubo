...
const RULES: Rule[] = [
  ...
  { terms: ["vajilla", "ollas", "juego de ollas", "cubiertos", "sarten", "sartenes", "cuchillo de cocina", "tabla de picar", "vasos", "copas", "platos"], category: "hogar", subcategory: "menaje", weight: 4 },
  { terms: ["cortina", "cortinas", "cojin", "cojines", "alfombra", "alfombras", "espejo decorativo", "cuadro decorativo", "florero"], category: "hogar", subcategory: "decoracion", weight: 4 },
